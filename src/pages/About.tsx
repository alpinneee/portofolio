  ...
  return (
    <div className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl font-bold text-white mb-4 glow-text">About Me</h1>
        ...
        <div className="flex flex-col md:flex-row items-center mb-16">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-3xl font-bold text-white mb-6 glow-text">Who I Am</h2>
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-8 text-center glow-text">My Journey</h2>
            ...
            <div className="space-y-12">
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right mb-6 md:mb-0">
                  <h3 className="text-xl font-bold text-white mb-2">2020 - Present</h3>
                  <h4 className="text-lg font-semibold text-blue-400 mb-2">Frontend Developer</h4>
                  <p className="text-gray-200">
                    Working on various web applications using modern technologies like React, TypeScript, and Tailwind CSS.
                  </p>
                </div>
                <div className="md:w-1/2 md:pl-12">
                  <div className="hidden md:block w-6 h-6 rounded-full glass absolute left-1/2 transform -translate-x-1/2"></div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-1/2 md:pl-12 mb-6 md:mb-0">
                  <h3 className="text-xl font-bold text-white mb-2">2017 - 2020</h3>
                  <h4 className="text-lg font-semibold text-blue-400 mb-2">UI/UX Designer</h4>
                  <p className="text-gray-200">
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 md:text-right mb-6 md:mb-0">
                  <h3 className="text-xl font-bold text-white mb-2">2014 - 2017</h3>
                  <h4 className="text-lg font-semibold text-blue-400 mb-2">Computer Science Degree</h4>
                  <p className="text-gray-200">
        ...
        <motion.div
          className="glass glass-card p-8 md:p-10"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.4 }}
        >
          <h2 className="text-3xl font-bold text-white mb-6 text-center glow-text">My Values</h2>
        ...
        >
          <h2 className="text-3xl font-bold text-white mb-6 glow-text">Ready to Work Together?</h2>
